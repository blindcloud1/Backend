...
export type BusinessDoc = DbDocBase & DbTimestamps & {
    name: string;
    address: string;
    phone?: string;
    email?: string;
...
export type JobDoc = DbDocBase & DbTimestamps & {
    title: string;
    description?: string;
    status: JobStatus;
    customerId: string;
...
export type ProductDoc = DbDocBase & DbTimestamps & {
    name: string;
    category: string;
    description: string;
    image: string;
...
export type BusinessSettingsDoc = DbDocBase & DbTimestamps & {
    businessId: string;
...
export type PricingTableDoc = DbDocBase & DbTimestamps & {
    businessId: string;
    name: string;
...
export type PushSubscriptionDoc = DbDocBase & DbTimestamps & {
    userId: string;
    endpoint: string;
    keys: PushSubscriptionKeys;
};
export type CustomPlanConfigDoc = DbDocBase & DbTimestamps & {
    jobPrice: number;
    productPrice: number;
    emailPrice: number;
    userPrice: number;
